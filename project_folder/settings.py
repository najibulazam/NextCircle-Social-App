...
SECRET_KEY = 'django-insecure-h3)+dyky^fmwojy#p)bb9rq%=54cabq-spn%gy3h6mv6ztiisz'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'socialapp.context_processors.categories_processor',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'nzIijguTjTeyMCRqHiXdpFsIrNyouFZn',
